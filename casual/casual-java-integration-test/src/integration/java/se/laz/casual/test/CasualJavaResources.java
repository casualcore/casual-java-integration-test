...
public class CasualJavaResources
{

    public static final String CASUAL_JAVA_CONTAINER_NAME = "casual-java";
    public static final String CASUAL_JAVA_CONTAINER_IMAGE = "192.168.68.106:32000/casual-java:3.3.10-SNAPSHOT";
    ...
    public static final Pod SIMPLE_CASUAL_JAVA_POD = new PodBuilder()
            ...
            .withNewSpec()
                .addNewContainer()
                    .withName( CASUAL_JAVA_CONTAINER_NAME )
                    .withImage( CASUAL_JAVA_CONTAINER_IMAGE )
                    ...
                    .withNewReadinessProbe()
                        ...
                        .endTcpSocket()
                    .endReadinessProbe()
                    .addNewEnv().withName( "CASUAL_HOST" ).withValue( CasualResources.SIMPLE_CASUAL_SERVICE_NAME ).endEnv()
